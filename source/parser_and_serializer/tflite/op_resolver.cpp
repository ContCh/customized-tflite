...
class DummyOptionResolver : public BaseOptionResolver {
 public:
    ...
    SerializeOption(const Operator& op, ::flatbuffers::FlatBufferBuilder* builder) const {
...
class Conv2DOptionResolver : public TfLiteOptionResolver<::tflite::Conv2DOptions, Conv2DOption> {
    ...
    SerializeOptionImpl(const Conv2DOption&               option,
        ...
        return tflite::CreateConv2DOptions(*builder, tflite_padding, option.stride_w,
                                           option.stride_h, fuse_activation, option.dilation_w,
                                           option.dilation_h);
    }
};
...
class DepthwiseConv2DOptionResolver
    ...
    SerializeOptionImpl(const DepthwiseConv2DOption&      option,
                        ::flatbuffers::FlatBufferBuilder* builder) const final {
        auto tflite_padding  = utils::GetMappedPaddingOf(option.pad_type);
        auto fuse_activation = utils::GetMappedActTypeOf(option.activation_type);
        return tflite::CreateDepthwiseConv2DOptions(
            *builder, tflite_padding, option.stride_w, option.stride_h, option.depth_multiplier,
            fuse_activation, option.dilation_w, option.dilation_h);
    }
};
...
class ReshapeOptionResolver : public TfLiteOptionResolver<::tflite::ReshapeOptions, ReshapeOption> {
    ...
    SerializeOptionImpl(const ReshapeOption&              option,
                        ::flatbuffers::FlatBufferBuilder* builder) const final {
...
class SoftmaxOptionResolver : public TfLiteOptionResolver<::tflite::SoftmaxOptions, SoftmaxOption> {
    ...
    SerializeOptionImpl(const SoftmaxOption&              option,
                        ::flatbuffers::FlatBufferBuilder* builder) const final {
...
class Pool2DOptionOptionResolver
    ...
    SerializeOptionImpl(const Pool2DOption&               option,
                        ::flatbuffers::FlatBufferBuilder* builder) const final {
        auto tflite_padding = utils::GetMappedPaddingOf(option.pad_type);
        return tflite::CreatePool2DOptions(*builder, tflite_padding, option.stride_w,
                                           option.stride_h, option.filter_w, option.filter_h);
    }
};
